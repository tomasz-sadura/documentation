...
Redpanda exports metrics for Managed Connectors through a Prometheus HTTPS endpoint for you to monitor connectors health.
You can use Prometheus and Grafana to visualize the metrics and set up alerting.
...
:::note
You can quickly start by [running the Prometheus and Grafana locally](https://github.com/redpanda-data/observability/tree/main/cloud).
:::
